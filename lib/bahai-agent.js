...
- Use the returned orderedIds to order the candidates and use reasonsById[id] as the short explanation for each property.
...
- Then present properties in reranker order (orderedIds)
